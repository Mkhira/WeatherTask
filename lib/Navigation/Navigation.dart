...
class PageNavigation extends PageRouteBuilder{
  ...
  PageNavigation({this.child, this.settings }):super(
    settings: settings,
      transitionDuration: Duration(milliseconds: 700),
      reverseTransitionDuration: Duration(milliseconds: 700),
      transitionsBuilder: (context, Animation<double> animation,Animation<double>secAnimation,Widget child){

        animation = CurvedAnimation(curve: Curves.easeInOutQuart,parent: animation,reverseCurve: Curves.fastLinearToSlowEaseIn);
...
class PageNavigationNoRout extends PageRouteBuilder{
  final Widget child;
  PageNavigationNoRout({this.child }):super(
      transitionDuration: Duration(milliseconds: 700),
      reverseTransitionDuration: Duration(milliseconds: 700),
      transitionsBuilder: (context, Animation<double> animation,Animation<double>secAnimation,Widget child){
