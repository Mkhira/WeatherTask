...
//   only these domains are allowed in email.
 static var domains = [
  ...
  static bool passwordValidation(String value) {
     ...
     if(value.contains(new RegExp(r'[!@#$%^&*(),.?":{}|<>]')) && value.length>=6 && value.contains(new RegExp(r'[A-Z]')) && value.contains(new RegExp(r'[a-z]')) ){

        return true;
     }else{
    return false;}
  }
 static bool passwordConfirmValidation(String value, String password) {
